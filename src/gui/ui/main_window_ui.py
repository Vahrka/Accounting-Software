...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MainSideNavFrame.setMinimumSize(QSize(240, 706))
        self.MainSideNavFrame.setMaximumSize(QSize(240, 16777215))
        self.MainSideNavFrame.setBaseSize(QSize(240, 0))
